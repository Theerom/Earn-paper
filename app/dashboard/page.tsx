  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-200 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card className="bg-white shadow-lg rounded-lg p-4">
          <CardHeader>
            <CardTitle className="text-xl font-semibold text-purple-600">Referral Stats</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white shadow-lg rounded-lg p-4">
          <CardHeader>
            <CardTitle className="text-xl font-semibold text-green-600">Pending Withdrawals</CardTitle>
          </CardHeader>
          <CardContent>
